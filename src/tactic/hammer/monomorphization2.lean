...
private meta def find_lemmas3_core (axs : option (list name)) (max_lemmas : ℕ) : tactic (list (expr × hammer.hol_tm)) := do
lems ←
  match axs with
